...
class Lab2 {
  public void linkedList() {
    // 1. Create a LinkedList<String> object called progLanguages
          var progLanguages = new LinkedList<String>();
  ...
  public void queue() {
    ...
    // 10. View the head of the queue using peek(). Output it's value.
      ...
      System.out.println("The head of the queue is now: " + queueHead);
  ...
  public void stack() {
    ...
    // 14. pop() 1 book off the stack. Display it's value
          ...
          System.out.println("The last book in was: " + popped);
    // 15. Use the peek() method to view the top book on the stack
          String peeked = bookStack.peek();
          System.out.println("The book currently on top is: " + peeked);
    ...
    // 17. Use the peek() method to view the top book on the stack
          String peeked2 = bookStack.peek();
          System.out.println("The book currently on top is now: " + peeked2);
    // 18. Search for "Design Patterns" in the stack. Display the results of the search.
          var searched = bookStack.search("Design Patterns");
          System.out.println("The index of 'Design Patterns' is: " + searched);

    // 19. Call empty(). Output the results
          System.out.println("Is the stack of books empty? Answer:" +bookStack.empty());

    // 20. Print the titles of all of the books on the stack
        for (var elem : bookStack){
